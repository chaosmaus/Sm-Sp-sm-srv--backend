...
$(document).ready(function () {
    ...
    {
        question1: {
            makeMoneySellingInsurance: false
        },
        question2a: {
            grossWrittenPremium: '1',
            lossRatio: '1',
            imNotSureSelected: false
        },
        question2b: {
            spentOnAnnualPremiumms: '1',
            imNotSureSelected: false
        },
        question3: {
            minClaimsAmount: '0',
            maxClaimsAmount: '750000',
            imNotSureSelected: false
        },
        question4: {
    ...
    $('.sm-button--submit').on('click', () => {
        ...
        //'https://www.xncapsrvcs.com/api/users/submit-quiz'
        $.ajax({
            url: 'https://www.xncapsrvcs.com/api/users/submit-quiz', 
            type: 'POST',
            headers: {
